...
// for display purposes
      ...
      // git 'https://github.com/raknas999/hello-world-servlet.git'
         ...
         git 'https://github.com/ArchanaaDevops2022/hello-world-servlet.git'
...
post {
        success {
            mail to:"archanaamt@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
